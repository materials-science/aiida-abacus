...
Check version number in setup.json and aiida_abacus/__init__.py and make sure
they match.
"""
...
import aiida_abacus  # pylint: disable=wrong-import-position
VERSION = aiida_abacus.__version__
