...
html_use_opensearch = 'http://aiida-abacus.readthedocs.io'
...
htmlhelp_basename = 'aiida-abacus-doc'
...
def run_apidoc(_):
    ...
    package_dir = os.path.join(source_dir, os.pardir, os.pardir, 'aiida_abacus')
